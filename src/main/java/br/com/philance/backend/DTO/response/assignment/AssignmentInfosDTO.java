...
public record AssignmentInfosDTO(
    ...
    public AssignmentInfosDTO(Assignment assignment){
        this(
                ...
                assignment.getFreelancer() !=null?assignment.getFreelancer().getId(): null,
                assignment.getFreelancer() !=null?assignment.getFreelancer().getUsername(): null,
                assignment.getAddress() !=null? assignment.getAddress().getId(): null,
